...
declare namespace Cypress {
	interface Chainable {
		...
		receiveMessage(
			text?: string,
			data?: Object,
			source?: "bot" | "agent" | "user",
		): Chainable<ReturnType<cy["window"]>>;
		...
		getMessageFromHistory(
			messageOrMatcher: Partial<IDummyMessage> | ((message: IDummyMessage) => boolean),
		): Chainable<IDummyMessage>;
