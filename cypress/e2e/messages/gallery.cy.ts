...
describe("Message with Gallery", () => {
	...
	it("should render gallery message", () => {
		cy.withMessageFixture("gallery", () => {
			cy.contains("foobar004g1");
			cy.contains("foobar004g3").should("be.not.visible");
		});
	});

	it("should render image inside gallery", () => {
		cy.withMessageFixture("gallery", () => {
			cy.get(".webchat-carousel-template-root > div > div").should(
				"have.css",
				"background-image",
			);
		});
	...
	it("should render subtitle", () => {
		cy.withMessageFixture("gallery", () => {
			cy.get(".webchat-carousel-template-subtitle").contains(
				/foobar004g2sub1\sfoobar004g2sub2/,
			);
		});
	});
	...
	it("should have scroll backward button", () => {
		cy.withMessageFixture("gallery", () => {
			cy.get(".gallery-button-prev")
				.should("not.be.visible")
				.get(".gallery-button-next")
				.click()
				.get(".gallery-button-prev")
				.should("be.visible");
		});
	});
