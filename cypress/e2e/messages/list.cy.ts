...
describe("Message with List", () => {
	...
	it("should render list", () => {
		cy.withMessageFixture("list", () => {
			cy.get(".webchat-message-row")
				.contains("foobar009l1")
				.get(".webchat-message-row")
	...
	it("should render lists subtitle", () => {
		cy.withMessageFixture("list", () => {
			cy.get(".webchat-message-row").contains("foobar009ls1");
		});
	});

	it("should render top element of the list large", () => {
		cy.withMessageFixture("list", () => {
			cy.get(".webchat-list-template-header > div").should("have.css", "background-image");
		});
	});
	...
	it("should render 'global' button", () => {
		cy.withMessageFixture("list", () => {
			cy.contains("foobar009b1");
		});
	});

	it("should have static class names", () => {
		cy.withMessageFixture("list", () => {
			cy.get(".webchat-list-template-header")
	...
	it("should render the list header image in a fixed aspect ratio", () => {
		cy.withMessageFixture("list", () => {
			cy.get(".webchat-list-template-header > :first-child")
				.parent()
				.then(element => {
