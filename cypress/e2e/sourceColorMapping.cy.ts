describe("Source Color Mapping", () => {
	...
	it("should render user messages as a shade of primary by default", () => {
		...
		cy.get(".webchat-message-row.user .chat-bubble").should(
			"have.css",
			"background-color",
			"rgb(232, 235, 255)",
		);
	...
	it("should render bot messages as neutral by default", () => {
		...
		cy.get(".webchat-message-row.bot .chat-bubble").should(
			"have.css",
			"background-color",
			"rgb(255, 255, 255)",
		);
	...
	it('should render agent messages as "neutral" by default', () => {
		...
		cy.get(".webchat-message-row.agent .chat-bubble").should(
			"have.css",
			"background-color",
			"rgb(255, 255, 255)",
		);
