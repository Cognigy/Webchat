...
| buttonGroupLabel          | string   | "Available actions:"                  | This text is used for live message announcements of text with buttons and quick replies messages and gallery messages.                                                                                           |
